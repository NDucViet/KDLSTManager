...
// private static final List<String> PUBLIC_PATH = new
// CopyOnWriteArrayList<>(Arrays.asList(
...
// private static final List<String> USER_PATH = new
// CopyOnWriteArrayList<>(Arrays.asList(
...
// private static final List<String> EMPLOY_PATH = new
// CopyOnWriteArrayList<>(Arrays.asList(
